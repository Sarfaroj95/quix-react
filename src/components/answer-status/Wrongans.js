...
export class Wrongans extends Component {
    render() {
        return (
            <div>
                                ...
                                <div className="right-section-quiz">
                                    <div className="top-section-quiz">
                                        ...
                                        <div className="top-right-quiz">
                                            <h1 className="time-quiz" id="demo">11:00</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div className="audio-section-question">
                                        ...
                                        select the correct option ?</h1>
                                            ...
                                            <div>
                                                <p className="wrong-tag">Sorry! Your answer is incorrect</p>
                                            </div>
                                            <div>
                                                <p className="explain">Correct answer is : (B) Peregrine Falcon</p>
                                            </div>
                                            <div className="mt-3">
